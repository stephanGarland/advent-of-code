...
class Solution:
    ...
    def subsumed_range(self, range_1, range_2):
        """
        Returns: tuple(range: <is subsumed by> range)
        """
        if all(e in range_1 for e in range_2):
            return (range_1, range_2)
        elif all(e in range_2 for e in range_1):
    ...
    def range_subsumptions(self):
        ...
        for section in self.data:
            ...
            subsumed = self.subsumed_range(range_1, range_2)
            if subsumed:
